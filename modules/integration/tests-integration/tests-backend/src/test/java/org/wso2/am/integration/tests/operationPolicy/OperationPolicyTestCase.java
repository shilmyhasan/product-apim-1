...
public class OperationPolicyTestCase extends APIManagerLifecycleBaseTest {
    ...
    public void testAPIInvocationAfterAddingNewOperationPolicy() throws Exception {
        ...
        apiOperationPoliciesDTO.setRequest(getPolicyList(policyName, POLICY_TYPE_COMMON, policyMap, attributeMap));
        apiOperationPoliciesDTO.setResponse(getPolicyList(policyName, POLICY_TYPE_COMMON, policyMap, attributeMap));
    ...
    public void testAPIInvocationAfterAddingNewMultipleOperationPolicies() throws Exception {
        ...
        requestPolicyList.add(getPolicyList(policyName, POLICY_TYPE_COMMON, policyMap, attributeMap).get(0));
        responsePolicyList.add(getPolicyList(policyName, POLICY_TYPE_COMMON, policyMap, attributeMap).get(0));
