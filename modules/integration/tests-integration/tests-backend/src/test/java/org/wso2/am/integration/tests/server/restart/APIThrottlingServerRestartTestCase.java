...
public class APIThrottlingServerRestartTestCase extends APIManagerLifecycleBaseTest {
    ...
    @Test(description = "API Throttling Test")
    public void checkThrottling() {
        log.info("=====================Check Throttling");
        String invokeURL = serverRestartTestCase.getApiThrottleInvokeURL();
        Map<String, String> requestHeaders = serverRestartTestCase.getApiThrottleRequestHeaders();
