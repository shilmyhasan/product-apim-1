...
ADD CONSTRAINT APPLICATION_ID_CONSTRAINT FOREIGN KEY (APP_ID) REFERENCES SP_APP (ID) ON DELETE CASCADE;
...
ADD CONSTRAINT APPLICATION_ID_CONSTRAINT_STEP FOREIGN KEY (APP_ID) REFERENCES SP_APP (ID) ON DELETE CASCADE;
...
ADD CONSTRAINT STEP_ID_CONSTRAINT FOREIGN KEY (ID) REFERENCES SP_AUTH_STEP (ID) ON DELETE CASCADE;
...
ADD CONSTRAINT DIALECTID_APPID_CONSTRAINT FOREIGN KEY (APP_ID) REFERENCES SP_APP (ID) ON DELETE CASCADE;
...
ADD CONSTRAINT CLAIMID_APPID_CONSTRAINT FOREIGN KEY (APP_ID) REFERENCES SP_APP (ID) ON DELETE CASCADE;
...
ADD CONSTRAINT ROLEID_APPID_CONSTRAINT FOREIGN KEY (APP_ID) REFERENCES SP_APP (ID) ON DELETE CASCADE;
...
ADD CONSTRAINT REQ_AUTH_APPID_CONSTRAINT FOREIGN KEY (APP_ID) REFERENCES SP_APP (ID) ON DELETE CASCADE;
...
ADD CONSTRAINT PRO_CONNECTOR_APPID_CONSTRAINT FOREIGN KEY (APP_ID) REFERENCES SP_APP (ID) ON DELETE CASCADE;
...
ADD CONSTRAINT TYPE_ID_FOREIGN_CONSTRAINT FOREIGN KEY (TYPE_ID) REFERENCES IDN_CONFIG_TYPE (ID) ON DELETE CASCADE;
...
ADD CONSTRAINT RESOURCE_ID_ATTRIBUTE_FOREIGN_CONSTRAINT FOREIGN KEY (RESOURCE_ID) REFERENCES IDN_CONFIG_RESOURCE (ID) ON DELETE CASCADE;
...
ADD CONSTRAINT RESOURCE_ID_FILE_FOREIGN_CONSTRAINT FOREIGN KEY (RESOURCE_ID) REFERENCES IDN_CONFIG_RESOURCE (ID);
...
-- IDN_FIDO2_PROPERTY --
CREATE INDEX IDX_FIDO2_STR ON FIDO2_DEVICE_STORE(
  USER_NAME,
  TENANT_ID,
  DOMAIN_NAME,
  CREDENTIAL_ID,
...
CREATE TABLE IF NOT EXISTS AM_IP_CONDITION (
  ...
  INDEX fk_AM_IP_CONDITION_1_idx (CONDITION_GROUP_ID ASC),
  CONSTRAINT fk_AM_IP_CONDITION_1 FOREIGN KEY (CONDITION_GROUP_ID) REFERENCES AM_CONDITION_GROUP (CONDITION_GROUP_ID) ON DELETE CASCADE
) ENGINE = NDB;
...
DELIMITER //
CREATE TRIGGER DELETE_IDP_PROV_CONFIG_PROPERTY
BEFORE DELETE ON IDP_PROVISIONING_CONFIG
FOR EACH ROW
BEGIN
  DELETE FROM IDP_PROV_CONFIG_PROPERTY WHERE ID = OLD.ID;
END;//

CREATE TRIGGER DELETE_IDN_CONFIG_FILE
BEFORE DELETE ON IDN_CONFIG_RESOURCE
FOR EACH ROW
BEGIN
  DELETE FROM IDN_CONFIG_FILE WHERE RESOURCE_ID = OLD.ID;
END;//

CREATE TRIGGER DELETE_IDN_REMOTE_FETCH_REVISIONS
BEFORE DELETE ON IDN_REMOTE_FETCH_CONFIG
FOR EACH ROW
BEGIN
  DELETE FROM IDN_REMOTE_FETCH_REVISIONS WHERE ID = OLD.ID;
END;//
